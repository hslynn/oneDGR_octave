...
%Hhat terms
[deri_plus_g00, deri_minus_g00] = deri(g00, g00_exact, g00_exact);
[deri_plus_g01, deri_minus_g01] = deri(g01, g01_exact, g01_exact);
[deri_plus_g11, deri_minus_g11] = deri(g11, g11_exact, g11_exact);
[deri_plus_Pi00, deri_minus_Pi00] = deri(Pi00, Pi00_exact, Pi00_exact);
[deri_plus_Pi01, deri_minus_Pi01] = deri(Pi01, Pi01_exact, Pi01_exact);
[deri_plus_Pi11, deri_minus_Pi11] = deri(Pi11, Pi11_exact, Pi11_exact);
[deri_plus_Phi00, deri_minus_Phi00] = deri(Phi00, Phi00_exact, Phi00_exact);
[deri_plus_Phi01, deri_minus_Phi01] = deri(Phi01, Phi01_exact, Phi01_exact);
[deri_plus_Phi11, deri_minus_Phi11] = deri(Phi11, Phi11_exact, Phi11_exact);
[deri_plus_S, deri_minus_S] = deri(S, S_exact, S_exact);
[deri_plus_Pi_S, deri_minus_Pi_S] = deri(Pi_S, Pi_S_exact, Pi_S_exact);
[deri_plus_Phi_S, deri_minus_Phi_S] = deri(Phi_S, Phi_S_exact, Phi_S_exact);
[deri_plus_psi, deri_minus_psi] = deri(psi, psi_exact, psi_exact);
[deri_plus_Pi_psi, deri_minus_Pi_psi] = deri(Pi_psi, Pi_psi_exact, Pi_psi_exact);
[deri_plus_Phi_psi, deri_minus_Phi_psi] = deri(Phi_psi, Phi_psi_exact, Phi_psi_exact);
